...
% \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
%     Problem 4:  Plotting 3 intersecting planes 
%
% \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
...
% -- Define matrix A 
 ...
 A = [ 1  0 10 ;       % -- row vector r1
       2  0  2 ;       % -- row vector r2
       2  0 -2 ]       % -- row vector r3 = r1 + 2r2
...
x_solution = [ -10  10  5 ]';   %  <---  you need to change this !!
...
% -- Then, add the 4th legend (the x = solution black dot)
 my_legend_strings{count+1}  = strcat( 'x_{solution} =  No solutions'  );
...
%campos([45.1837   89.3282  331.6307]);
campos([3.7008  345.7381  -21.2480]);
